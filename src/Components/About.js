    ...
    <div className="about-me-main">
      <div className="about-me">
        ...
        <p>
          ...
          date of Dec. 2024. <br></br>I have developed a strong passion for
          computer programming, acquiring skills in a range of programming
          languages and technologies including SQL, GitHub, JavaScript, Java,
          C++, C, Python, Numpy, Matplotlib, PyTorch, Jax. My main focus is Web
          Devlopment as it is in my opinion a critical role in 2024. I am
          currently learning ReactJs, Node.js, Express and MongoDB to fine tune
          my full stack developper skills
